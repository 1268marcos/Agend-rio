...
/**
 classe 'Phrase'
 Representa a estrutura de dados da entidade/tabela FRASES. As colunas (campos da tabela)
 ID, CREATIONDATE, DESCRIPTION, AUTHOR e SCORE serão criadas como membros privados da classe. As
...
public class Phrase {
    /**
     ...
     public void setAuthor(String author) {
        mAuthor = author.toUpperCase().trim();
     }
     Clique com o botão direito do mouse sobre o nome da classe 'Phrase' e escolha
